...
<header>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      ...
      <!-- LOGO -->
      <a class="navbar-brand fw-bold" href="<?= BASE_URL ?>menu.php">
        <img src="../juegunco.ico" height="50" width="50"> Juegunco
      </a>
