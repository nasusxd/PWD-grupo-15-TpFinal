...
if (!$tienePermiso) {
    ...
    echo '<div class="container text-center"><a href="../login/login.php" class="btn btn-secondary">Volver al Login</a></div>';
        ...
        <div class="card-body">
            ...
            <?php
                ...
                case 'editar':
                    ...
                    echo "<p>Acá debes poner el formulario para editar los datos.</p>";
                    break;
            }
            ?>
