...
class Menu
{
    ...
    public function setDireccion($url)
    {
        $this->medireccion = $url;
    }
    ...
    public function setear($idmenu, $menombre, $medescripcion, $medireccion, $objMenuPadre, $medeshabilitado)
    {
        $this->idmenu = $idmenu;
        $this->menombre = $menombre;
        $this->medescripcion = $medescripcion;
        $this->medireccion = $medireccion;
        $this->idpadre = $objMenuPadre?->getIdMenu() ?? null;
